...
for detector in detectors:
	img = DeepFace.detectFace("E:/FaceDatesets/celeba/img_celeba/202355.jpg", detector_backend = detector)
...
img_path = "E:/FaceDatesets/celeba/img_celeba/202355.jpg"
...
dataset = [
	['E:/FaceDatesets/celeba/img_celeba/202355.jpg', 'E:/FaceDatesets/celeba/img_celeba/202356.jpg', True],
	['E:/FaceDatesets/celeba/img_celeba/202358.jpg', 'E:/FaceDatesets/celeba/img_celeba/202359.jpg', True]
]
...
df = DeepFace.find(img_path = "E:/FaceDatesets/celeba/img_celeba/202355.jpg", db_path = "dataset"
	#, model_name = 'Dlib'
)
print(df.head())
...
dfs = DeepFace.find(img_path = ["E:/FaceDatesets/celeba/img_celeba/202355.jpg", "E:/FaceDatesets/celeba/img_celeba/202357.jpg"], db_path = "dataset"
	#, model_name = 'Dlib'
)
print(dfs[0].head())
print(dfs[1].head())
